...
<head>
    ...
    <body>
        <div class="wrap">
            ...
            <p>Pentru a instala o licență, accesați <a href="/licente">/licente</a> (interfața de gestionare a licențelor).</p>
            <div class="hint">Dacă considerați că această pagină apare din greșeală, contactați suportul tehnic și furnizați informațiile despre licență.</div>
        </div>
    </body>
    </html>
